...
def _get_dataset(params, experiment):
    if params.dataset == "MNIST":
        ...
        print("LLL", test_labels.shape, test_labels[0])
        print('xxxxxxxx', np.max(test_images))
...
def _get_model_v2(params, experiment):
    ...
    if params.model == "LeNet5":
      #CHanged
      #model 2 ke deghat balatareh
        # model = keras.models.load_model('models/mnist_lenet5_supply/train_on_0.2tr/mnist_lenet5_supply_v2.h5')
        # model=keras.models.load_model("/content/drive/MyDrive/Paper_Diff_testing/DNN_Models/mnist_Model2.h5")
        # model.compile(loss='categorical_crossentropy', optimizer='adam', metrics=['accuracy'])

        # ##################################################### JUST FORMODEL 8  #########################
        lr = 1e-1
        model=keras.models.load_model("/content/drive/MyDrive/Paper_Diff_testing/DNN_Models/cifar10_Model2_v1.h5")
 ...
 ##################################################### JUST FORMODEL 6  #########################
        ...
        # model=keras.models.load_model("/content/drive/MyDrive/Paper_Diff_testing/DNN_Models/mnist_Model6_v3.h5")
        # # custom_learning_rate = 0.0001
...
#Changed
        ...
        # model=keras.models.load_model("/content/drive/MyDrive/Paper_Diff_testing/DNN_Models/mnist_Model1.h5")
        # model.compile(loss='categorical_crossentropy', optimizer='adam', metrics=['accuracy'])

##################################################### JUST FORMODEL 7
     
      model=keras.models.load_model("/content/drive/MyDrive/Paper_Diff_testing/DNN_Models/cifar10_Model1_v1.h5")
      lr = 1e-1 
      # opt = optimizers.SGD(lr=lr, momentum=0.9, nesterov=False)
      # model.compile(optimizer=opt,
      #            loss=losses.categorical_crossentropy,
...
# ##################################################### TILL here
 ##################################################### JUST FORMODEL 5  #########################
        ...
        # model=keras.models.load_model("/content/drive/MyDrive/Paper_Diff_testing/DNN_Models/mnist_Model5_v3.h5")
        # # custom_learning_rate = 0.0001
